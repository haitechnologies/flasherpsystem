 ...
 * @var string $lead_id
 * @var string $quotation_no
 * @var string $quotation_status
 * @var string $quotation_date
    ...
    <div class="page-header page-header-light shadow carriers-page-header">
        <div class="page-header-content border-top py-2 px-3 carriers-page-header-content">
            ...
            <div class="my-1 d-flex align-items-center gap-2">
                <?php if ($canCreate): ?>
                    <?php if ($id > 0): ?>
                        <button type="button" form="frmquotations" class="submit-form btn btn-primary btn-sm">Save</button>
                    <?php else: ?>
                        <button type="button" form="frmquotations" class="save-draft-quotation btn btn-primary btn-sm">Save as Draft</button>
                    <?php endif; ?>
                    <button type="button" form="frmquotations" class="save-and-send-quotation btn btn-info btn-sm">Save and Send</button>
                <?php endif; ?>
                <?php if ($id > 0): ?>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mb-2">
                                        <label class="col-lg-3 col-form-label">Lead:</label>
                                        <div class="col-lg-9">
                                            <select name="lead_id" id="lead_id" class="form-control select">
                                                <option value='0'>Please select</option>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="form-control-feedback form-control-feedback-start">
                                                <input type="text" class="form-control" placeholder="Quotation Date" name="quotation_date" id="quotation_date" value="<?php echo $quotation_date; ?>">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.submit-form', function(e) {
            e.preventDefault();
            let form = document.getElementById('frmquotations');
            form.submit();
        });
        $(document).on('click', '.save-draft-quotation', function(e) {
            e.preventDefault();
            var form = document.getElementById('frmquotations');
            form.submit();
        });
        $(document).on('click', '.save-and-send-quotation', function(e) {
            e.preventDefault();
