                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-lg-9">
                                            <select name="lead_id" id="lead_id" class="form-select" onchange="toggleQuotationPartySelectors()">
                                                <option value="0">Please select</option>
...
<script>
    ...
    function toggleQuotationPartySelectors() {
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.save-draft-quotation', function(e) {
            e.preventDefault();
            document.getElementById('quotation_status').value = 'draft';
            document.getElementById('frmquotations').submit();
        });
        ...
        $(document).on('click', '.save-and-send-quotation', function(e) {
            ...
            document.getElementById('quotation_status').value = 'sent';
            document.getElementById('frmquotations').submit();
        });
