            ...
            <form class="steps-basic clearfix" method="post" id="frm<?php echo $module; ?>" name="frm<?php echo $module; ?>" action="<?php echo $module; ?>.php">
                ...
                <div class="card col-lg-6">
                    <div class="card-body clearfix">
                        <div class="row mb-3">
                            <label class="col-lg-3 col-form-label"><span class="text-danger">Shipper Name: <span class="text-danger">*</span></span></label>
                            <div class="col-lg-9">
                                <input required type="text" name="shipper_name" value="<?php echo htmlspecialchars($shipperName); ?>" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
