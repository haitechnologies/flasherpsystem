 ...
 * @var string $debit_note_no
 * @var string $debit_note_date
 * @var string $debit_note_status
 * @var string $reference_no
 * @var string $vendor_id
 * @var string $purchase_id
 * @var string $warehouse_id
 * @var string $purchase_person
    ...
    <div class="page-header page-header-light shadow carriers-page-header">
        <div class="page-header-content border-top py-2 px-3 carriers-page-header-content">
            <div class="my-1 d-flex align-items-center gap-2">
                ...
                <?php if ($id > 0): ?>
                    <span class="badge bg-success bg-opacity-10 text-success ms-2">Debit Note #: <?php echo $debit_note_no; ?></span>
                <?php endif; ?>
                <span class="badge bg-primary bg-opacity-10 text-primary ms-2"><?php echo !empty($debit_note_status) ? ucwords($debit_note_status) : ''; ?></span>
            </div>
            <div class="my-1 d-flex align-items-center gap-2">
                <?php if ($canCreate): ?>
                    <?php if ($id > 0): ?>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-lg-9">
                                            <select name="vendor_id" id="vendor_id" class="form-control select">
                                                ...
                                                <?php foreach ($vendorsList as $row): ?>
                                                    <option value="<?php echo $row['id']; ?>" <?php echo (string)$row['id'] === $vendor_id ? 'selected' : ''; ?>>
                                    ...
                                    <div class="row mb-2">
                                        <label class="col-lg-3 col-form-label"><span class="text-danger">Debit Note Date:*</span></label>
                                        <div class="col-lg-9">
                                            <div class="form-control-feedback form-control-feedback-start">
                                                <input type="text" class="form-control" placeholder="Debit Note Date" name="debit_note_date" id="debit_note_date" value="<?php echo $debit_note_date; ?>">
                                    ...
                                    <div class="row mb-2">
                                        <label class="col-lg-3 col-form-label">Purchase Person:</label>
                                        <div class="col-lg-9">
                                            <select name="purchase_person" id="purchase_person" class="form-select">
                                                <option value='0'>Please select</option>
                                                <?php foreach ($warehousesList as $row): ?>
                                                    <option value="<?php echo $row['id']; ?>" <?php echo (string)$row['id'] === $purchase_person ? 'selected' : ''; ?>>
                                                        <?php echo $row['warehouse_name']; ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
