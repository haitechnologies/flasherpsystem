 ...
 * @var string $vendor_status
 * @var array $sourcesList
 * @var string $vendor_source
 * @var array $usersList
 * @var string $assigned_to
 * @var int $is_active
 * @var string $vendor_owner
                                    ...
                                    <div class="col-lg-9">
                                        <div class="mt-2">
                                            <div class="form-check form-check-inline">
                                                <input type="radio" class="form-check-input" name="vendor_type" id="vendor_type_business" value="business" <?php echo $vendor_type == 'business' || $vendor_type == '' ? 'checked' : ''; ?>>
                                                <label class="form-check-label">Business</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input type="radio" class="form-check-input" name="vendor_type" id="vendor_type_individual" value="individual" <?php echo $vendor_type == 'individual' ? 'checked' : ''; ?>>
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <select class="form-select" name="vendor_status" id="vendor_status">
                                                ...
                                                <?php foreach ($statusesList as $row): ?>
                                                    <option value="<?php echo $row['id']; ?>" <?php echo (string)$row['id'] === $vendor_status ? 'selected' : ''; ?>>
                                                        <?php echo $row['value']; ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <select class="form-select" name="vendor_source" id="vendor_source">
                                                ...
                                                <?php foreach ($sourcesList as $row): ?>
                                                    <option value="<?php echo $row['id']; ?>" <?php echo (string)$row['id'] === $vendor_source ? 'selected' : ''; ?>>
                                                        <?php echo $row['value']; ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="">
                                            <select class="form-select" name="vendor_owner" id="vendor_owner">
                                                <option value='0'></option>
                                                <?php foreach ($usersList as $row): ?>
                                                    <option value="<?php echo $row['id']; ?>" <?php echo (string)$row['id'] === $vendor_owner ? 'selected' : ''; ?>>
                                                        <?php echo $row['full_name']; ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                    ...
                                    <div class="col-lg-8">
                                        <select class="form-select" name="currency" id="currency">
                                            ...
                                            <?php foreach ($currencyList as $row): ?>
                                                <option value="<?php echo $row['id']; ?>" <?php echo ((string)$row['id'] === (string)$currency) ? 'selected' : ''; ?>>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-8">
                                        <select class="form-select" name="lead_category" id="lead_category">
                                            <option value='0'></option>
                                            <option value="lead" <?php echo $lead_category == 'lead' ? 'selected' : ''; ?>>Lead Vendor</option>
                                            <option value="direct" <?php echo $lead_category == 'direct' ? 'selected' : ''; ?>>Direct Vendor</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-2">
