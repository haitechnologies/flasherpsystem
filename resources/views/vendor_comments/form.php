                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <form class="steps-basic clearfix" method="post" id="frm<?php echo $module; ?>" name="frm<?php echo $module; ?>" action="<?php echo $module; ?>.php" autocomplete="off" enctype="multipart/form-data">
                                        ...
                                        <?php if (($action == "edit_$module" || $action == "update_$module") && !empty($vendor_id)): ?>
                                                    ...
                                                    <div class="d-flex mb-4 position-relative">
                                                        ...
                                                        <div class="ms-3 flex-grow-1">
                                                            ...
                                                            <div class="bg-light rounded p-3 d-flex justify-content-between align-items-center">
                                                                ...
                                                                <div class="d-flex">
                                                                    <?php if ($canEdit): ?>
                                                                    <a href="vendor_comments.php?action=edit_vendor_comments&comment_id=<?php echo $noteId; ?>&vendor_id=<?php echo $vendor_id; ?>"
                                                                       class="btn btn-link text-muted p-0 me-2" title="Edit">
                                                                        <i class="ph-pencil-simple"></i>
                                                                    </a>
                                                                    <?php endif; ?>
                                                                    <?php if ($canDelete): ?>
                                                                    <form method="post" action="vendor_comments.php" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this comment?')">
                                                                        <input type="hidden" name="action" value="delete_vendor_comments">
