...
class JobRepository
{
    ...
    /**
     * Find by a specific field (for duplicate check)
     */
    ...
    private function mapRowToJob(array $row): Job
    {
        return new Job(
            ...
            loadingPlace: $row['loading_place'] !== null ? (string)$row['loading_place'] : null,
            ...
            projectCreated: (string)($row['project_created'] ?? '0'),
