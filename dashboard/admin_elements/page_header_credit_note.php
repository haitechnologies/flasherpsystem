...
<div class="page-header page-header-light shadow">
    <div class="page-header-content d-lg-flex border-top py-2 px-3 align-items-center">
        <div class="my-1">
            <h1 class="ms-2"><a href="credit_note_overview.php?credit_note_id=<?php echo $credit_note_id; ?>" class="text-black"><?php echo $display_no; ?></a></h1>
        ...
        <div class="my-1 ms-auto d-flex align-items-center gap-2 flex-wrap">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <a href="credit_note_overview.php?credit_note_id=<?php echo $credit_note_id; ?>&action=clone_<?php echo $module; ?>" class="dropdown-item"><i class="ph-copy me-2"></i> Clone</a>
                    <a href="listing_<?php echo $module; ?>.php?action=delete_<?php echo $module; ?>&id=<?php echo $credit_note_id; ?>" class="dropdown-item"><i class="ph-trash me-2"></i> Delete</a>
                </div>
            </div>
        </div>
    </div>
