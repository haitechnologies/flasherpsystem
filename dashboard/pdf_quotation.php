...
if (!empty($id)) {
    ...
    if ($result->num_rows === 0) die('Quotation not found.');
    ...
    // Quotation items
    $result_quotation_items = $mysqli->query("SELECT * FROM `" . DB::QUOTATION_ITEMS . "` WHERE quotation_id = $id ORDER BY id");
    $total_rows = $result_quotation_items->num_rows;

    if ($total_rows > 0) {
        while ($item = $result_quotation_items->fetch_array()) {
...
<tr>
    <td width="335"><strong>QUOTATION TO</strong><br />$display_name</td>
    <td width="335" align="right"><strong>QUOTATION #</strong><br /> $quotation_no</td>
</tr>
<tr>
    <td width="325">
        <table>
    ...
    <td width="325">
        ...
        <tr><td width="120">Quotation Date:</td><td>$quotation_date</td></tr>
