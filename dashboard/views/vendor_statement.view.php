...
<style>
/* =========================================================================
   Vendor Statement – Zoho-Inspired Premium Styles
   ========================================================================= */
.stmt-toolbar {
    display: flex;
    align-items: center;
...
.type-badge.purchase { background: #e8f0fe; color: #1a73e8; }
.type-badge.payment { background: #e6f4ea; color: #188038; }
.type-badge.debit-note { background: #fce8e6; color: #c5221f; }
...
<div class="content-wrapper">
    ...
    <div class="stmt-document" id="statementDocument">
        ...
        <!-- Vendor Details + Account Summary -->
        <div class="stmt-parties">
            <div class="bill-to">
                <div class="label">Pay To</div>
                <h5><?php echo e($vendorData->displayName); ?></h5>
                <?php if ($vendorData->companyName && $vendorData->companyName !== $vendorData->displayName): ?>
                    <div class="address-text" style="font-weight:600;"><?php echo e($vendorData->companyName); ?></div>
                <?php endif; ?>
                <div class="address-text">
                    <?php if ($vendorData->address): ?>
                        <?php echo nl2br(e($vendorData->address)); ?><br>
                    <?php endif; ?>
                    <?php if ($vendorData->phone): ?>
                        <?php echo e($vendorData->phone); ?><br>
                    <?php endif; ?>
                    <?php if ($vendorData->email): ?>
                        <?php echo e($vendorData->email); ?>
                    <?php endif; ?>
                    <?php if ($vendorData->trn): ?>
                        <br>TRN: <?php echo e($vendorData->trn); ?>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="stmt-summary">
                ...
                <div class="summary-body">
                    ...
                    <div class="summary-row">
                        <span class="lbl">Purchased Amount</span>
                    ...
                    <div class="summary-row">
                        <span class="lbl">Debit Notes Applied</span>
        ...
        <table class="stmt-table">
            ...
            <tbody>
                ...
                foreach ($transactions as $tx):
                    ...
                    $isDebitNote = ($tx['type'] === 'Debit Note');
                    ...
                    $badgeClass = $isPurchase ? 'purchase' : ($isPayment ? 'payment' : 'debit-note');
                ?>
                <tr>
                    ...
                    <td class="<?php echo $isPurchase ? 'text-right' : 'text-muted-dash'; ?>"><?php echo $isPurchase ? e($currency_code) . ' ' . number_format($amt, 2) : '&mdash;'; ?></td>
                    <td class="<?php echo ($isPayment || $isDebitNote) ? 'text-right' : 'text-muted-dash'; ?>" style="<?php echo ($isPayment || $isDebitNote) ? 'color:#188038;' : ''; ?>"><?php echo ($isPayment || $isDebitNote) ? e($currency_code) . ' ' . number_format($amt, 2) : '&mdash;'; ?></td>
